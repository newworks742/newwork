...
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="bg-white">${validate_component(Toaster, "Toaster").$$render(
    ...
    {},
    {}
  )}</button></div>  <div${add_attribute("class", `fixed top-0 left-0 h-full bg-primary-900 bg-opacity-70 transition-transform transform ${"-translate-x-full"} md:hidden z-50 w-9/12 overflow-y-auto`, 0)}><div class="flex flex-col h-full p-6 text-primary"><div class="flex justify-between p-2 overflow-hidden"><button class="text-xl lg:text-3xl py-2 font-roboto font-bold md:mb-0 text-white" data-svelte-h="svelte-10fx6l5">Digitoad Technologis</button> <button class="text-2xl py-2 hover:text-primary-400">${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:close", class: "size-6" }, {}, {})}</button></div> ${`${each(menus, (menu) => {
...
//# sourceMappingURL=_layout.svelte-Be8I22W8.js.map
