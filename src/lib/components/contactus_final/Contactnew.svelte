...
<div
	class="bg-cover bg-center bg-no-repeat relative min-h-screen flex items-center justify-center"
	style="background-image: url('unnamed.jpg');"
>
		...
		<div class="flex justify-center items-center min-h-screen">
			{#if showSuccesDiv}
				<div class="text-center">
					<div
						class="backdrop-blur-sm bg-white/90 rounded-2xl shadow-2xl p-6 sm:p-8 mx-auto max-w-sm"
					>
						...
						<a
							...
							class="inline-block bg-gradient-to-r from-primary-600 to-primary-600 hover:from-primary-700 hover:to-primary-700 text-white font-semibold py-2 px-6 rounded-lg transition duration-300 transform hover:scale-105 shadow-lg text-sm"
						>
			...
			{:else}
				<div
					class="backdrop-blur-sm w-full max-w-3xl bg-black/40 rounded-2xl shadow-2xl border border-white/20 p-4 sm:p-6 md:p-8"
				>
					...
					<form method="POST" action="?/contactus" use:enhance={handlesubmit}>
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
							<!-- Name Field -->
							<div class="space-y-1">
								<label for="name" class="text-white font-medium mb-1 text-sm">
								...
								<div class="relative group">
									<input
										...
										placeholder="john"
										maxlength="50"
										class="w-full px-3 py-2 backdrop-blur-sm bg-white/20 border border-white/30 rounded-lg focus:outline-none focus:ring-0 focus:ring-primary-400 focus:border-transparent placeholder-white/60 text-white transition-all duration-300 hover:bg-white/25 text-sm"
										on:input={(e) => {
                ...
                > -->
								<label for="email" class="text-white font-medium mb-1 text-sm">
							...
							<!-- Phone Number Field -->
							<div class="space-y-1">
								<label for="phone" class="text-white font-medium mb-1 text-sm">
								...
								<div class="relative flex">
									<div class="relative w-24 sm:w-28">
										<input
											...
											class="w-full px-3 py-2 backdrop-blur-sm bg-white/20 border border-white/30 rounded-l-lg focus:outline-none focus:ring-0 focus:ring-primary-400 focus:border-transparent placeholder-white/60 text-white transition-all duration-300 hover:bg-white/25 text-sm"
										/>
										{#if showDropdown}
											<div
												bind:this={dropdownEl}
												class="absolute w-64 sm:w-80 mt-1 backdrop-blur-lg bg-white/90 border border-white/30 rounded-lg z-50 shadow-2xl"
											>
									...
									<div class="flex-1">
										<input
											...
											name="phone"
											bind:value={phone}
											class="w-full px-3 py-2 backdrop-blur-sm bg-white/20 border border-white/30 rounded-r-lg border-l-0 focus:outline-none focus:ring-0 focus:ring-primary-400 focus:border-transparent placeholder-white/60 text-white transition-all duration-300 hover:bg-white/25 text-sm"
							...
							<!-- Subject Field -->
							<div class="space-y-1">
								<label for="subject" class="block text-white font-medium text-sm">
							...
							<div class="md:col-span-2 space-y-1">
								<label for="message" class="block text-white font-medium text-sm">
								...
								<div class="relative group">
									<textarea
										...
										bind:value={message}
										rows="4"
										class="w-full px-3 py-2 backdrop-blur-sm bg-white/20 border border-white/30 rounded-lg focus:outline-none focus:ring-0 focus:ring-primary-400 focus:border-transparent placeholder-white/60 text-white transition-all duration-300 hover:bg-white/25 resize-none text-sm"
										maxlength="200"
										on:input={(e) => {
											e.target.value = e.target.value.replace(/^\s+/, '');
						...
						<div class="mt-6 flex justify-center">
							<div
								class="backdrop-blur-sm bg-white/20 rounded-lg p-3 border border-white/30 w-full max-w-md"
							>
								<div
									class="flex items-center justify-between bg-white/30 p-3 rounded-lg mb-3 backdrop-blur-sm"
								>
									<div class="flex gap-1 font-bold text-lg tracking-widest text-white">
										{#each captcha.split('') as char}
											<span class="bg-white/20 px-2 py-1 rounded text-sm">{char}</span>
										{/each}
									</div>
									<button
										type="button"
										on:click={generateCaptcha}
										class="bg-primary-500 hover:bg-primary-600 text-white rounded-lg p-2 transition-colors duration-300 shadow-lg"
									>
								...
								<input
									...
									class="w-full backdrop-blur-sm bg-white/20 border border-white/30 p-3 rounded-lg text-center placeholder-white/60 text-white focus:outline-none focus:ring-0 focus:ring-primary-400 transition-all duration-300 text-sm"
						...
						<div class="flex justify-center mt-8">
							<button
								type="submit"
								class="w-full sm:w-auto bg-gradient-to-r from-primary-500 to-primary-500 hover:from-primary-700 hover:to-primary-700 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-2xl flex justify-center items-center text-sm"
								disabled={submitting}
							>
								{#if submitting}
